...
from training.network_training.nnFormerTrainerCascadeFullRes import nnFormerTrainerCascadeFullRes
from training.network_training.nnFormerTrainerV2_CascadeFullRes import nnFormerTrainerV2CascadeFullRes
