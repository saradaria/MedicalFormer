...
import sys 
sys.path.append('/home/ubuntu/Desktop/nnFormer/nnformer/training/network_training')
sys.path.append('/home/ubuntu/Desktop/nnFormer/nnformer/run')
sys.path.append('/home/ubuntu/Desktop/nnFormer/nnformer/training/cascade_stuff')
...
import nnformer
from predict_next_stage import predict_next_stage
from nnFormerTrainer import nnFormerTrainer
from nnFormerTrainerV2_nnformer_tumor import nnFormerTrainerV2_nnformer_tumor
from nnFormerTrainerCascadeFullRes import nnFormerTrainerCascadeFullRes
from nnFormerTrainerV2_CascadeFullRes import nnFormerTrainerV2CascadeFullRes
...
def main():
    ...
    #                       nnFormerTrainer) or issubclass(trainer_class, nnFormerTrainerV2_nnformer_tumor) , "network_trainer was found but is not derived from nnFormerTrainer"
