...
class nnFormer(SegmentationNetwork):
    ...
    def forward(self, x):
        ...
        #     print('end_outsss :' + str(encoder_outputs[i].shape) )

        # enc1 = self.encoder1(x)
        # print('enc1 : '+ str(enc1.shape))
        # x2 = outs[0]
        # enc2 = self.encoder2(x2)
        # print('enc2 '+ str(enc2.shape))
        # x3 = outs[1]
        # enc3 = self.encoder3(x3)
        # print('enc3 ' +  str(enc3.shape))
        # x4 = outs[2]
        # enc4 = self.encoder4(x4)
        # print('enc4' + str(enc4.shape))
        # enc_hidden = self.encoder5(outs[3])
        # print('enc5' + str(enc_hidden.shape))
        

        #out[0] = stem, nu avem nev de el
        skips = [outs[1], outs[2], outs[3], outs[4]]
