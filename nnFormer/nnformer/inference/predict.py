...
from postprocessing.connected_components import load_remove_save, load_postprocessing
...
from nnformer.training.network_training.nnFormerTrainerV2_nnformer_tumor import nnFormerTrainerV2_nnformer_tumor
...
def preprocess_multithreaded(trainer, list_of_lists, output_files, num_processes=2, segs_from_prev_stage=None):
    ...
    assert isinstance(trainer, nnFormerTrainer) or isinstance(trainer, nnFormerTrainerV2_nnformer_tumor)
    q = Queue(1)
    processes = []
