...
from network_architecture.nnFormer_tumor import nnFormer
...
class nnFormerTrainerV2_nnformer_tumor(nnFormerTrainer):
    ...
    def initialize_network(self):
        ...
        if self.load_pretrain_weight:
            checkpoint = torch.load("/home/ubuntu/Desktop/nnFormer/nnFormer_trained_models/model_best.model", map_location='cpu')
            ck={}
            ...
            print('I am using random weight! ')
