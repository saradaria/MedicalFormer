...
from training.network_training.nnFormerTrainerV2_nnformer_tumor import nnFormerTrainerV2_nnformer_tumor
...
def restore_model(pkl_file, checkpoint=None, train=False, fp16=None,folder=None):
    ...
    assert issubclass(tr, nnFormerTrainer) or issubclass(tr, nnFormerTrainerV2_nnformer_tumor), "The network trainer was found but is not a subclass of nnFormerTrainer.Please make it so!"
